...
<!-- Mirrored from xincomblog.com/html5-templates/medical/page-our-doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2019 13:06:01 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    <title>Nursing Home/ Aged Clinic</title>
            ...
            <div class="wrap-inner">          
                ...
                <nav id="main-nav" class="main-nav">
                    <ul class="menu">
                        ...
                        <li class="current-menu-item"><a href="page-our-doctors.html">Our doctors</a></li>
                        <li><a href="page-time-table.html">Timetable</a></li>                                               
                        <li><a href="page-blog.html">New</a></li>                        
                    </ul>
                </nav><!-- /#main-nav -->
    ...
    <div id="featured-title-inner" class="wprt-container">
        <div class="featured-title-inner-wrap">
            <div class="featured-title-heading-wrap">
                <h1 class="featured-title-heading ">DEPARTMENTS</h1>
            </div>

            <div id="breadcrumbs">
                <div class="breadcrumbs-inner">
                    <div class="breadcrumb-trail">
                        <a href="#" title="Contruction2" rel="home" class="trail-begin">Home</a>
                        <span class="sep">/</span>
                ...
                <div class="page-content">
                    <div class="wprt-container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/1-360x300.jpg" height="300" width="360" alt="image">
                                            </div>

                                            <div class="text-wrap">
                                                <h3 class="title"><a href="#">Dr. Tony Hammond</a></h3>
                                                <p class="position">Anaesthetist</p>
                                                <div class="desc">
                                                    Lorem ipsum dolor sit amet, consect adipiscing elit. Nulla sodal arcu vitae justo dictum, eu fermentum  
                                                </div>
                                                <div class="wprt-btn">
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/2-360x300.jpg" height="300" width="360" alt="image">
                                            </div>

                                            <div class="text-wrap">
                                                <h3 class="title"><a href="#">Dr. Terry Ludgrove</a></h3>
                                                <p class="position">Throat Specialist</p>
                                                <div class="desc">
                                                    Lorem ipsum dolor sit amet, consect adipiscing elit. Nulla sodal arcu vitae justo dictum, eu fermentum   
                                                </div>
                                                <div class="wprt-btn">
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/3-360x300.jpg" height="300" width="360" alt="image">
                                            </div>

                                            <div class="text-wrap">
                                                <h3 class="title"><a href="#">Dr. Gerry Saldanha</a></h3>
                                                <p class="position">Cardiologist</p>
                                                <div class="desc">
                                                    Lorem ipsum dolor sit amet, consect adipiscing elit. Nulla sodal arcu vitae justo dictum, eu fermentum   
                                                </div>
                                                <div class="wprt-btn">
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/4-360x300.jpg" height="300" width="360" alt="image">
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/5-360x300.jpg" height="300" width="360" alt="image">
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="wprt-image-box text-center has-shadow clearfix">
                                    <div class="item">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="assets/img/doctors/6-360x300.jpg" height="300" width="360" alt="image">
                                            </div>
    ...
    <div id="bottom-bar-inner" class="wprt-container">
        <div class="bottom-bar-inner-wrap">
            <div class="bottom-bar-content">
                <div id="copyright">
                    &copy; 2018 MedicalHealth, All rights reserved
                </div><!-- /#copyright -->
