...
$sql ="SELECT * FROM `visitor` WHERE v_id='$user'";
...
<div id="wrapper" class="animsition">
    <div id="page" class="clearfix">
        <!-- Site Header Wrap -->
        <?php if(isset($_SESSION['id'])){ include('contNavbar.php'); } else include('mainNavbar.php');?><!-- /#site-header-wrap -->
                                            ...
                                            <div class="wprt-content-box request-form-1 bg-white">
                                                <div class="inner">
                                                    <div class="wprt-headings clearfix text-left">
                                                        <h2 class="heading font-size-18">Update Visitor</h2>
                                                    </div><!-- /.wprt-headings -->

                                                    <div class="wprt-spacer clearfix" data-desktop="30" data-mobi="30" data-smobi="30"></div>
                                                    <form action="updateVisiterInfo.php?user=<?php echo $user;?>" method="post">

                                                    <span class="name">
                                                        <input type="text" tabindex="2" value="<?php echo $data['v_name']; ?>" id="name" name="name" placeholder="Enter Your Name">
                                                    </span>
                                        
                                                    <span class="email">
                                                        <input type="email" tabindex="2" value="<?php echo $data['email']; ?>" id="email" name="email" placeholder="Enter Your Email">
                                                    </span>
                                                    
                                                    <span class="password">
                                                        <input type="text" tabindex="2" value="<?php echo $data['password']; ?>" id="password" name="password" placeholder="Enter Your Password">
                                                    </span>
                                                    
                                                    <br>
                                                        
                                                    <div class="wrap-submit">
                                                                <input type="submit" value="Update NOW" id="submit" name="submit-checkOut">
                                                    </div>
