...
<!DOCTYPE html>
    ...
    <title>Nursing Home/ Aged Care</title>
                                            ...
                                            <div class="wprt-content-box request-form-1 bg-white">
                                                <div class="inner">
                                                    <div class="wprt-headings clearfix text-left">
                                                        <h2 class="heading font-size-18">User CheckOut</h2>
                                                    </div><!-- /.wprt-headings -->
                                                    ...
                                                    <div class="wrap-submit">
                                                                <input type="submit" value="Check-Out NOW" id="submit" name="submit-checkOut">
                                                    </div>
...
if(isset($_REQUEST['submit-checkOut'])){
    ...
    if($cat=='contactor'){
        $sql="SELECT * FROM `contractor` WHERE c_email='$email'";
         ...
         $sqll="SELECT * FROM `contractor_history` WHERE `c_id` = '$c_id' AND `timeout` IS NULL";
         ...
         if($data){
             ...
             $sql="UPDATE `contractor_history` SET `timeout` = '$ctime' WHERE `contractor_history`.`id` = '$id'";
             $resss=mysqli_query($con,$sql);
             if($resss){
                 ?>
             <script>
                 alert('You Have Sucesfully Checked Out');
             </script>
             <?php
             }
             else{
        ...
        $sql="SELECT * FROM `visitor` WHERE email='$email'";
         ...
         $sqll="SELECT * FROM `patient_visit` WHERE `v_id` = '$v_id' AND `outgoingtime` IS NULL";
         $ress=mysqli_query($con,$sqll);
         if($ress){
             $data=mysqli_fetch_assoc($ress);
             $user = $data['id'];
             ...
             $sqlll="UPDATE `patient_visit` SET `outgoingtime` = '$ctime' WHERE `patient_visit`.`id` = '$user'";
             $res=mysqli_query($con,$sqlll);
             if($res){
                 ?>
                <script>
                     alert('You Have Sucessfully Checked Out');
                </script>
                 <?php
             }
         }
