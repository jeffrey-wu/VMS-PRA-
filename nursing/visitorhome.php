                            ...
                            <div class="row-request-1">
                                <div class="wprt-container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $encode=base64_encode($data['email']);
                                            ...
                                            <div class="wprt-content-box request-form-1 bg-white">
                                                <div class="inner">
                                                    <div class="wprt-headings clearfix text-left">
                                                        <h2 class="heading font-size-18" align="center">Visitor's Detail</h2>
                                                    </div><!-- /.wprt-headings -->

                                                    <div class="wprt-spacer clearfix" data-desktop="30" data-mobi="30" data-smobi="30"></div>


                                                    <form action="updateVisitor.php?user=<?php echo $user;?>" method="post">
                                                    <span class="wpcf7-form-control-wrap name">
                                                        <label> Name  :</label>
                                                        <b class="wpcf7-form-control-wrap"><?php echo $data['v_name']?></b>
                                                    </span>
                                                        <br>
                                                    <span class="">
                                                        <label>Email  :  </label>
                                                        <b class="cond"><?php echo $data['email']?></b>
                                                    </span>
                                                        <br>
                                                    <span class="wpcf7-form-control-wrap name">
                                                        <label>Password  :  </label>
                                                        <b class="cond"><?php echo $data['password']?></b>
                                                    </span>
                                                        <br>
                                                    <span class="wpcf7-form-control-wrap name">
                                                     ...
                                                     <div class="wrap-submit">
                                                         <input type="submit" value="Change Detail" class="submit wpcf7-form-control wpcf7-submit" id="submit" name="submit">
                                                     </div>
                                                    </form>
                                                </div>
