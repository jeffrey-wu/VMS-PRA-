        ...
        <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Next To Kin </label> 
                      
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          
                          <input name="nextkin" type="text"  class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="Insert patient" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    $insert_patient = "insert into patient (FirstName, LastName,Age, Gender,PhoneNumber, RegistrationDate, City, nextkin) values ('$FirstName','$LastName','$Age','$Gender','$PhoneNumber',NOW(),'$City','$nextkin')";
