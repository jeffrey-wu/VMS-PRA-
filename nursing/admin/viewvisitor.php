                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $user_query = $_POST['user_query'];
                                 $get_pro = "select * from visitor where v_name like '%$user_query%'";
                                }else{
                                     $get_pro = "select * from visitor";     
                                }
                                ...
                                while($row_pro=mysqli_fetch_array($run_pro)){
                                    ...
                                    $email = $row_pro['email'];
                                    $get_pat = "select * from patient where ID='$p_id'";
                                    $run_pat = mysqli_query($con,$get_pat);
                                    $row_pat=mysqli_fetch_array($run_pat);
                                    $pfname = $row_pat['FirstName'];
                                    $plname=$row_pat['LastName'];
                            ...
                            <tr><!-- tr begin -->
                               ...
                               <td> <?php echo $email; ?> </td>
                                ...
                                <td> 
                                      ...
                                      <form method="post" action="deletevisitor.php" ><!-- navbar-form Begin -->
